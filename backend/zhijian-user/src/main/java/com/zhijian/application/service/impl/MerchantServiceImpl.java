...
import com.zhijian.application.service.MerchantService;
...
import com.zhijian.interfaces.dto.merchant.MerchantApplyDTO;
import com.zhijian.interfaces.dto.merchant.MerchantAuditDTO;
import com.zhijian.interfaces.dto.merchant.MerchantQueryDTO;
...
public class MerchantServiceImpl extends ServiceImpl<MerchantMapper, Merchant> implements MerchantService {
    ...
    @Override
    public Result updateSettings(Long userId, com.zhijian.interfaces.dto.merchant.MerchantSettingDTO settingDTO) {
        Merchant merchant = getByUserId(userId);
        if (merchant == null) {
            return Result.failed("商家不存在");
        }
