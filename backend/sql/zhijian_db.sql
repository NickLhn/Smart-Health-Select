...
CREATE TABLE `sys_merchant` (
  ...
  `legal_person_id_last4` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '法人身份证号后4位',
  `legal_person_id_hash` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '法人身份证号哈希',
  `legal_person_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '法人证件住址',
  `id_card_authority` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '身份证签发机关',
  `id_card_valid_from` date DEFAULT NULL COMMENT '身份证有效期开始',
  `id_card_valid_to` date DEFAULT NULL COMMENT '身份证有效期结束',
  `id_card_valid_long_term` tinyint(4) DEFAULT '0' COMMENT '身份证长期有效: 1是 0否',
