      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin scrollbar-thumb-gray-200">
        {messages.map((msg) => (
          ...
          >
            ...
            />
            <div
              className={`max-w-[85%] md:max-w-[70%] p-3.5 rounded-2xl shadow-sm text-sm leading-relaxed ${
                msg.sender === 'user'
        ...
        {loading && (
           <div className="flex gap-3">
             <Avatar icon={<RobotOutlined />} className="bg-[#00B96B] flex-shrink-0" />
             <div className="bg-white p-3.5 rounded-2xl rounded-tl-none shadow-sm flex items-center gap-2">
