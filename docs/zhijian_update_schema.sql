...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '购物车表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `dms_delivery`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配送信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_delivery`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配送单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `oms_delivery` VALUES (30, 39, NULL, NULL, NULL, '刘昊楠', '13796323223', '陕西西安欧锦圆C座4单元', 0, '2026-01-04 20:46:54', '2026-01-04 20:46:54', '西安大药房', '陕西省西安市雁塔区科技二路', 5.00, NULL, 0, '3649', 0, NULL);
INSERT INTO `oms_delivery` VALUES (31, 40, NULL, NULL, NULL, '刘昊楠', '13796323223', '陕西西安欧锦圆C座4单元', 0, '2026-01-04 20:52:52', '2026-01-04 20:52:52', '西安大药房', '陕西省西安市雁塔区科技二路', 5.00, NULL, 0, '2060', 0, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单主表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `oms_order` VALUES (41, '20260104205621483307886', 6, 4, 5, 38.80, 0.00, 44.80, NULL, 1, '刘昊楠', '13796323223', '陕西西安欧锦圆C座4单元', 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/f85eb2d7544a4e0bb1318a4c23d16584.jpg', 2, NULL, NULL, '2026-01-04 20:56:46', NULL, NULL, '2026-01-04 20:56:21', '2026-01-04 20:56:21', 0, NULL, NULL, '1');
...
CREATE TABLE `oms_order_item`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oms_payment_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付记录表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `pms_banner` VALUES (5, '轮播图一', 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/fd8bd42ec897430196e6d0c8fd3fb302.jpg', NULL, 0, 1, '2026-01-04 14:57:07', '2026-01-04 14:57:07');
INSERT INTO `pms_banner` VALUES (6, '轮播图二', 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/dd39a4c65f2e4893925539b4aa008f22.jpg', NULL, 0, 1, '2026-01-04 14:57:57', '2026-01-04 14:57:57');
...
-- ----------------------------
INSERT INTO `pms_medicine` VALUES (1, '阿莫西林胶囊', 24, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/c150113b4f6440b1b6e05c16fa8e7d8e.jpg', 25.50, 500, 320, 1, '用于敏感菌所致的呼吸道感染、泌尿道感染、皮肤软组织感染等', '口服，一次0.5g，每6-8小时1次', '青霉素过敏者禁用', '2025-12-31', '2023-10-15', 5, 1, '2023-11-01 09:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (2, '头孢克肟片', 25, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/2c19cedb3bea4308ab6a0195e6b0abb5.jpg', 38.80, 299, 211, 1, '用于敏感菌引起的支气管炎、肺炎、肾盂肾炎、膀胱炎等', '口服，一次0.1g，一日2次', '对头孢菌素类抗生素过敏者禁用', '2025-09-30', '2023-09-20', 5, 1, '2023-11-02 10:00:00', '2026-01-04 20:56:46', '标准规格');
INSERT INTO `pms_medicine` VALUES (3, '阿奇霉素片', 26, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/c6f9dd557b16414b9d36a0d0040236cf.jpg', 42.60, 400, 180, 1, '用于敏感菌引起的呼吸道感染、皮肤软组织感染', '口服，一日1次，一次0.5g', '对大环内酯类抗生素过敏者禁用', '2025-11-30', '2023-08-25', 5, 1, '2023-11-03 11:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (4, '硝苯地平缓释片', 27, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/2a311bd1fd034a58a9e872b011eb6861.jpg', 18.90, 600, 450, 1, '用于高血压、心绞痛', '口服，一次10-20mg，一日2次', '严重低血压、心源性休克患者禁用', '2026-03-31', '2023-12-01', 5, 1, '2023-11-05 14:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (5, '阿托伐他汀钙片', 28, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/46651597443a45c0b0a6f594a0f3e431.jpg', 65.40, 350, 280, 1, '用于高胆固醇血症、冠心病', '口服，一次10-20mg，一日1次', '活动性肝病患者禁用', '2026-06-30', '2023-11-15', 5, 1, '2023-11-06 15:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (6, '硝酸甘油片', 29, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/b591ea5bae8a48128475d7315e74382f.jpg', 12.80, 800, 520, 1, '用于心绞痛急性发作', '舌下含服，一次0.5mg', '严重贫血、颅内压增高者禁用', '2025-08-31', '2023-07-30', 5, 1, '2023-11-07 16:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (7, '奥美拉唑肠溶胶囊', 8, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/b1a9daf796f740d6b3317655b0c68c20.jpg', 36.70, 450, 310, 0, '用于胃溃疡、十二指肠溃疡、反流性食管炎', '口服，一次20mg，一日1-2次', '对本品过敏者禁用', '2025-10-31', '2023-10-10', 5, 1, '2023-11-08 09:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (8, '多潘立酮片', 8, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/bef2b01e664648c98cfeb322d4597bd5.jpg', 15.20, 549, 391, 0, '用于消化不良、腹胀、嗳气、恶心、呕吐', '口服，一次10mg，一日3次', '胃肠道出血、机械性肠梗阻患者禁用', '2025-07-31', '2023-06-25', 5, 1, '2023-11-09 10:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (9, '布洛芬缓释胶囊', 9, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/568bcd3f3a104f4a8c5ad67b7005fe87.jpg', 22.50, 700, 560, 0, '用于缓解轻至中度疼痛，如头痛、关节痛、偏头痛等', '口服，一次0.3g，一日2次', '对阿司匹林过敏的哮喘患者禁用', '2025-05-31', '2023-04-20', 5, 1, '2023-11-10 11:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (10, '对乙酰氨基酚片', 9, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/e582fba5e920488d84612307725e6b09.jpg', 8.90, 900, 720, 0, '用于普通感冒或流行性感冒引起的发热，缓解轻至中度疼痛', '口服，一次0.3-0.6g，一日3-4次', '严重肝肾功能不全者禁用', '2025-09-30', '2023-08-15', 5, 1, '2023-11-11 12:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (11, '盐酸氨溴索口服溶液', 10, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/c482d36875864a56b2238356141a2d53.jpg', 28.40, 380, 240, 0, '用于急、慢性呼吸道疾病引起的痰液粘稠、咳痰困难', '口服，一次10ml，一日3次', '对本品过敏者禁用', '2025-04-30', '2023-03-28', 5, 1, '2023-11-12 13:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (12, '孟鲁司特钠片', 10, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/62182130bd4645c8a06ee83c2596396e.jpg', 52.60, 280, 190, 1, '用于成人及儿童哮喘的预防和长期治疗', '口服，一次10mg，一日1次', '对本品过敏者禁用', '2025-12-31', '2023-11-05', 5, 1, '2023-11-13 14:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (13, '连花清瘟胶囊', 30, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/e5e21ae1aba840ca9641cfb5ad874996.jpg', 35.80, 420, 380, 0, '用于治疗流行性感冒属热毒袭肺证', '口服，一次4粒，一日3次', '对本品过敏者禁用', '2025-08-31', '2023-07-25', 5, 1, '2023-11-15 08:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (14, '板蓝根颗粒', 30, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/9ca207e1798e409a809d498e04a13b75.jpg', 12.50, 850, 650, 0, '用于肺胃热盛所致的咽喉肿痛、口咽干燥', '开水冲服，一次1-2袋，一日3-4次', '对本品过敏者禁用', '2025-10-31', '2023-09-18', 5, 1, '2023-11-16 09:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (15, '藿香正气口服液', 31, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/72bd27b908254c71bbdaadda557633af.jpg', 24.90, 520, 410, 0, '用于外感风寒、内伤湿滞所致的感冒', '口服，一次5-10ml，一日2次', '对本品过敏者禁用', '2025-07-31', '2023-06-30', 5, 1, '2023-11-17 10:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (16, '保和丸', 31, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/6dca3d39e0d94f78962a60d3de906b54.jpg', 18.70, 479, 321, 0, '用于食积停滞，脘腹胀满，嗳腐吞酸，不欲饮食', '口服，一次6-9g，一日2次', '孕妇慎用', '2025-09-30', '2023-08-22', 5, 1, '2023-11-18 11:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (17, '乌鸡白凤丸', 32, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/a1b5a0ab0ed94ac48376ebd85cdbe316.jpg', 46.80, 320, 210, 0, '用于气血两虚，身体瘦弱，腰膝酸软，月经不调', '口服，一次6g，一日2次', '对本品过敏者禁用', '2025-12-31', '2023-11-10', 5, 1, '2023-11-19 12:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (18, '益母草颗粒', 32, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/dc26b43d56ff4cae98e48e78375e5182.jpg', 16.40, 580, 430, 0, '用于血瘀所致的月经不调，产后恶露不绝', '开水冲服，一次1袋，一日2次', '孕妇禁用', '2025-06-30', '2023-05-25', 5, 1, '2023-11-20 13:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (19, '电子血压计', 33, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/b973b7d8ab014d47bf5346b2dce56398.jpg', 158.00, 119, 86, 0, '用于家庭血压监测', '按照说明书操作', '无', '2027-12-31', '2023-10-05', 5, 1, '2023-11-22 14:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (20, '血糖仪', 34, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/bededac3cf0e40b3968b6ed793884088.jpg', 198.00, 95, 62, 0, '用于糖尿病患者血糖监测', '配合试纸使用，按照说明书操作', '无', '2026-11-30', '2023-09-12', 5, 1, '2023-11-23 15:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (21, '电子体温计', 35, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/bc2875f41f9f4f8bbfd68280683062f9.jpg', 32.50, 280, 190, 0, '用于体温测量', '腋下或口腔测量，按照说明书操作', '无', '2026-08-31', '2023-07-18', 5, 1, '2023-11-24 16:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (22, '维生素C咀嚼片', 36, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/bf3592e60b9e4b5ba987f2c4b6cd2f81.jpg', 45.60, 650, 520, 0, '补充维生素C，增强免疫力', '咀嚼，一次1片，一日1次', '对本品过敏者禁用', '2025-03-31', '2023-02-28', 5, 1, '2023-11-26 08:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (23, '碳酸钙D3片', 37, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/8586fcab50ee4b96836aa3b88a17ec0b.jpg', 68.90, 420, 310, 0, '补钙，预防骨质疏松', '口服，一次1片，一日1-2次', '高钙血症、高尿酸血症患者禁用', '2025-05-31', '2023-04-15', 5, 1, '2023-11-27 09:30:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (24, '创可贴', 21, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/2b9478d7ea064a4f91c265fa26c708da.jpg', 5.80, 1497, 1203, 0, '用于小创伤、擦伤等患处', '清洁伤口后贴于患处', '对胶布过敏者慎用', '2026-04-30', '2023-03-10', 5, 1, '2023-11-28 10:30:00', '2026-01-04 20:46:20', '标准规格');
INSERT INTO `pms_medicine` VALUES (25, '医用纱布', 22, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/196104cb650a4538997b7bcd485cf3a9.jpg', 12.30, 977, 753, 0, '用于伤口包扎、止血', '清洁伤口后覆盖包扎', '无', '2027-02-28', '2023-01-20', 5, 1, '2023-11-29 11:30:00', '2026-01-04 20:52:48', '标准规格');
INSERT INTO `pms_medicine` VALUES (26, '盐酸左氧氟沙星片', 24, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/2cc38112c5994152ba5c95189c719847.jpg', 28.70, 0, 420, 1, '用于敏感菌引起的呼吸道、泌尿系统感染', '口服，一次0.2g，一日2次', '对喹诺酮类药物过敏者禁用', '2024-06-30', '2022-12-25', 5, 0, '2023-10-15 09:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (27, '复方甘草片', 30, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/0d64c9886c5b4f06a5ca50821a890937.jpg', 15.40, 0, 280, 1, '用于镇咳祛痰', '口服，一次2-3片，一日3次', '孕妇及哺乳期妇女禁用', '2024-03-31', '2022-10-20', 5, 0, '2023-10-20 10:00:00', '2026-01-04 14:40:51', '标准规格');
INSERT INTO `pms_medicine` VALUES (68, '1111', 1, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/c17fb1a4e42a4d01857cbc91d5a5e718.jpg', 11.00, 111, 0, 0, '11', '1', '1', '2026-01-29', '2026-01-12', 5, 1, '2026-01-04 20:53:57', '2026-01-04 21:08:49', '标准规格');
INSERT INTO `pms_medicine` VALUES (69, '11', 7, 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/975262be4a504098ad5413124c83133b.jpg', 11.00, 111, 0, 0, '11', '11', '11', '2026-01-19', '2026-01-04', 5, 1, '2026-01-04 21:09:12', '2026-01-04 21:09:48', NULL);
...
CREATE TABLE `pms_medicine_favorite`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_medicine`(`user_id` ASC, `medicine_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '药品收藏表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of pms_medicine_favorite
-- ----------------------------
INSERT INTO `pms_medicine_favorite` VALUES (4, 6, 25, '2026-01-04 20:48:03', '2026-01-04 20:48:03');
...
CREATE TABLE `pms_medicine_footprint`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 353 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '药品足迹表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `pms_medicine_footprint` VALUES (331, 6, 15, '2026-01-04 15:18:26', '2026-01-04 15:18:26');
INSERT INTO `pms_medicine_footprint` VALUES (339, 6, 24, '2026-01-04 20:46:12', '2026-01-04 20:46:11');
INSERT INTO `pms_medicine_footprint` VALUES (343, 6, 25, '2026-01-04 20:52:39', '2026-01-04 20:52:38');
INSERT INTO `pms_medicine_footprint` VALUES (345, 5, 68, '2026-01-04 20:55:51', '2026-01-04 20:55:50');
INSERT INTO `pms_medicine_footprint` VALUES (347, 6, 2, '2026-01-04 20:56:12', '2026-01-04 20:56:11');
INSERT INTO `pms_medicine_footprint` VALUES (349, 6, 10, '2026-01-04 21:00:36', '2026-01-04 21:00:36');
INSERT INTO `pms_medicine_footprint` VALUES (351, 6, 69, '2026-01-04 21:09:36', '2026-01-04 21:09:35');
INSERT INTO `pms_medicine_footprint` VALUES (352, 5, 69, '2026-01-04 21:09:44', '2026-01-04 21:09:43');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商家信息表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `sys_patient` VALUES (4, 6, '刘昊楠', '230281200203053216', 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/b12da79a14514da4ae132f18bdb1931c.jpeg', 'https://liuhaonan-java-ai.oss-cn-shenzhen.aliyuncs.com/zhijian/2026/01/04/9fd4899b425047a2851432e996563958.jpeg', '13796323223', 1, '2002-03-05', 1, '2026-01-04 13:49:13', '2026-01-04 13:49:13');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (5, 'seller', '$2a$10$s/iBuv17QIcv9mJ0LkY47uQLIWScGb5mBieHKxsg7CumBKu6qF.hu', NULL, '13000000000', 'SELLER', NULL, 1, '2025-12-29 14:19:50', '2025-12-29 14:54:09');
INSERT INTO `sys_user` VALUES (6, 'user', '$2a$10$BOV0Lcgy2gxnmIfPVjz5aOvl.KNaeZVK4q/ld523RBbtWtrq8OrLm', NULL, '13100000000', 'USER', NULL, 1, '2025-12-29 14:22:02', '2025-12-29 16:13:31');
INSERT INTO `sys_user` VALUES (7, 'admin', '$2a$10$mlYMiTX2cFb2LYaFbUR1lOuyfi7G.zdtD2WeSFbgMOJ10CTosf.va', NULL, '13200000000', 'ADMIN', NULL, 1, '2025-12-29 14:22:36', '2025-12-29 14:23:00');
INSERT INTO `sys_user` VALUES (13, '13400000000', '$2a$10$mnBliNIv.wxQqy1MhmjWfO6/V5Fj/9lOCsh8ht6gFd/UUICXXt3Fa', NULL, '13400000000', 'RIDER', NULL, 1, '2025-12-30 15:10:21', '2025-12-30 15:10:21');
...
CREATE TABLE `sys_user_address`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户收货地址表' ROW_FORMAT = DYNAMIC;
